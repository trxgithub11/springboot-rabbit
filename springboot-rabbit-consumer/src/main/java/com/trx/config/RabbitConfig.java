...
public class RabbitConfig {
    @Value("${com.trx.firstqueue}")
    private String firstQueue;

    @Value("${com.trx.secondqueue}")
    private String secondQueue;

    @Value("${com.trx.thirdqueue}")
    private String thirdQueue;

    @Value("${com.trx.fourthqueue}")

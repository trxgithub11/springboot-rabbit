...
import com.trx.util.Constant;
import com.trx.util.LayuiData;
import com.trx.service.MerchantService;
...
//        merchant.setState(Constant.MERCHANT_STATE.ACITVE);
        Merchant merchant = new Merchant();
        merchant.setAccountNo("1111");
        merchant.setName("sss");
        merchant.setAddress("34535");
        merchant.setAccountName("sdsdsd");
        merchant.setState(Constant.MERCHANT_STATE.ACITVE);
